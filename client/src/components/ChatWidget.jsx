...
export default function ChatWidget() {
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 right-0 z-9999 w-sm sm:w-sm h-full bg-bg-dark border-l border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden transition-transform duration-500 cubic-bezier(0.16, 1, 0.3, 1) ${open ? 'translate-x-0' : 'translate-x-full'}`}>
