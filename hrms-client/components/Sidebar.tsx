...
import { LayoutDashboard, Users, Settings, LogOut, CheckSquare, Calendar, CalendarDays, UserCircle, TrendingUp, Clock, FileText, Activity, Globe, BookOpen, Zap } from 'lucide-react';
  ...
  return (
    <div className="w-64 bg-slate-900 text-white h-screen fixed left-0 top-0 flex flex-col shadow-xl">
      <div className="p-6 border-b border-slate-800 flex items-center gap-4">
        <div className="flex items-center justify-center w-10 h-10 bg-white rounded-lg text-indigo-600 shadow-[0_0_20px_rgba(99,102,241,0.4)]">
          <Zap size={18} fill="currentColor" />
        </div>
        <span className="text-xl font-bold tracking-tight">CareerLens HRMS</span>
      </div>
