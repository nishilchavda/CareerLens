        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 text-sm font-semibold text-blue-600 bg-blue-50 px-3 py-2     rounded-xl border border-blue-100 shadow-sm whitespace-nowrap">
                        <Calendar size={14} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    ...
                    <Card key={id} className="p-0 border-none shadow-sm bg-white hover:shadow-md transition-all cursor-default group">
