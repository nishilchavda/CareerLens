...
export const LeaveManagement: React.FC = () => {
    ...
    return (
        <div className="pb-12">
            ...
            {/* Table Section */}
            <div className="bg-white rounded-3xl hover:shadow-lg border border-slate-100 overflow-hidden mt-8">
            ...
            {isAllocationModalOpen && (
                <div className="fixed inset-0 z-110 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
                    <Card className="w-full max-w-lg border-none shadow-2xl overflow-hidden bg-white animate-in zoom-in-95 duration-200">
                        {/* Modal Header */}
                        <div className="bg-slate-900 p-6 py-6 rounded-xl text-white relative">
                            <button
                                ...
                                <div className="space-y-4">
                                    {selectedHistoryUser.leaveHistory.map((leave: any, idx: number) => (
                                        <div key={idx} className="bg-white rounded-2xl p-6 border border-slate-100 flex gap-6 transition-all hover:border-blue-200 hover:shadow-xl hover:shadow-blue-50/50 group">
                                            <div className={`h-14 w-14 rounded-2xl shrink-0 flex items-center justify-center shadow-lg transition-transform group-hover:scale-110 ${leave.category === LeaveCategory.PAID ? 'bg-blue-600 text-white shadow-blue-100' :
